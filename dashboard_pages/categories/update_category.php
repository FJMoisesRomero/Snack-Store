...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Verificar si la categoría ya existe, excluyendo la que se está actualizando
    $stmt = $conn->prepare("SELECT COUNT(*) FROM categorias WHERE REPLACE(LOWER(nombre), ' ', '') = :nombre AND id != :id");
